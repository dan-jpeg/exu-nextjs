...
// Backwards-compatible lazy proxies. Existing call sites use `adminDb.collection(...)`
// and `adminStorage.bucket(...)`; the proxy defers initialization until first access.
